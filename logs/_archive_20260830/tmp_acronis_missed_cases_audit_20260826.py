...
partners = [
    'Pure Technology /1',
    'Keystone',
    'Keystone Information Technology',
    'Virtual Communication Specialists 1',
    'In-Telecom',
    'The Learning Exchange',
    'GSG Computers, Inc.',
    'SHARKTOOTH NETWORKS INC',
    'Total Group International Ltd.',
    'DigitalBrainz',
    'Strong Conne'
]

like_clause = " OR ".join([f"VENDOR_PARTNER_NAME ILIKE '%{p.replace("'","''")}%" for p in partners])
...
queries = {
    'detail_june_focus': f'''
        ...
        WHERE VENDOR='Acronis' AND BILLING_MONTH='2026-06-01'::DATE AND ({like_clause})
    ...
    'partner_map_focus': '''
        ...
        WHERE PARTNER_NAME ILIKE '%Pure Technology /1%'
           OR PARTNER_NAME ILIKE '%Keystone%'
           OR PARTNER_NAME ILIKE '%Virtual Communication Specialists 1%'
           OR PARTNER_NAME ILIKE '%In-Telecom%'
           OR PARTNER_NAME ILIKE '%The Learning Exchange%'
           OR PARTNER_NAME ILIKE '%GSG Computers, Inc.%'
           OR PARTNER_NAME ILIKE '%SHARKTOOTH NETWORKS INC%'
           OR PARTNER_NAME ILIKE '%Total Group International Ltd.%'
           OR PARTNER_NAME ILIKE '%DigitalBrainz%'
           OR PARTNER_NAME ILIKE '%Strong Conne%'
