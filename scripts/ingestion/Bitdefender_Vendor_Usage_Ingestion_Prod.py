...
CREATE OR REPLACE TABLE BITDEFENDER_USAGE_PROD AS
SELECT
    BILLING_MONTH,
    ...
    CASE WHEN COUNT(DISTINCT UNIT_PRICE) = 1 THEN MAX(UNIT_PRICE)::NUMBER(18,6) ELSE NULL::NUMBER(18,6) END AS UNIT_PRICE,
...
DROP TABLE IF EXISTS BITDEFENDER_USAGE;

CREATE OR REPLACE VIEW BITDEFENDER_USAGE AS
SELECT * FROM BITDEFENDER_USAGE_PROD;
"""
